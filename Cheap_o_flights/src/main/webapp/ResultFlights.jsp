...
<body>
   <div  id="table" >
	<div id="title">
		<h2 id="table_title" style="color:white;text-align:center; padding:10px 0px 10px 0px; font-weight:800;">Flight Details </h2>
	</div>
	...
	try{
		...
		ResultSet rs=st.executeQuery("select * from flights where Source='"+arr[1]+"' and Destination='"+arr[2]+"' and To_Day='"+arr[4]+"'");
		...
		%>
			<tr>
  					...
  					<th><a href="CustomerDetail.jsp?msg=<%=rs.getInt("Flight_id")%>"><button class="btn btn-primary">Book This Flight</button></a></th>
  				</tr>
