...
<title>NexJ Shoewear Delivery Page</title>
<link href="../springdemo/path/css/Style.css" rel="stylesheet"
	type="text/css">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			PreparedStatement ps = con1.prepareStatement(
					"insert into purchasereport(Company,Category,Price,Username,Address,Ordereddate)values(?,?,?,?,?,?)");
		...
		<div class="col-md-6">
			...
			<h3>
				...
				<%=username%></h3>
			<p>
				Address:<br><%=address%></p>
		</div>
		<div style="margin: 0px 40px;">
			<a href="Home" class="btn btn-primary">Continue Shoping</a>
		</div>
	</div>
</body>
</html>