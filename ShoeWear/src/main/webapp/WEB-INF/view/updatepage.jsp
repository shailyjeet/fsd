	...
	<div class="row">
		<div id="box1" style="box-shadow: 0px 20px 5px;" class="col-lg-4">
			<a id="logout" href="Adminhome">Back</a> <a
				href="ProductPage">Product List</a> <a href="AddProduct.jsp">Add
				Product</a> <a href="DeleteProduct.jsp">Delete Product</a> <a
		...
		<div id="box2" class="col-lg-8">
			<form method="post" action="updateproduct">
				<label class="form-label">Company Name</label> <input
					...
					autocomplete="off"> <label class="form-label">Category</label>
				<input class="form-control" type="text" name="category"
					autocomplete="off"> <label class="form-label">Price</label>
				<input class="form-control" type="text" name="price"
					autocomplete="off"> <label class="form-label">Features</label>
				<input class="form-control" type="text" name="features"
					autocomplete="off"> <input type="submit"
					Style="margin: 10px 0px;" class="btn btn-danger">
			</form>
		</div>
	</div>
