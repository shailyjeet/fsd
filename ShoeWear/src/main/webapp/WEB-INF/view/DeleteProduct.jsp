...
<title>NexJ Shoewear Delete Product Page</title>
<style>
box1 {
	height: 100vh;
	width: 300px;
...
<body>
	<div class="row">
		<div id="box1" style="box-shadow: 0px 20px 5px;" class="col-lg-4">
			<a id="logout" href="Adminhome">Back</a> 
			<a href="ProductPage">Product List</a> 
		...
		<div id="box2" class="col-lg-8">
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					while (rs.next()) {
					%>
					<form action="deleteproduct?msg=<%=rs.getString("Id")%>"
						method="post">
						<tr>
