...
<body>
	<a id="back" href="UserHomePage" class="btn btn-primary">Back</a>
	<div class="row">
		<div class="col-md-6">
			<div id="bigimage">
				<img alt="img"
		...
		<div class="col-md-6">
			...
			<div>
				<a href="Buy" class="btn btn-primary" id="buy">Buy</a>
				<form action="addtokart" method="post">
					<button type="submit"
						onclick="alert('Item successfully added into the kart');"
						class="btn btn-warning" id="addkart">Add to Kart</button>
				</form>
			</div>
		</div>
	</div>
